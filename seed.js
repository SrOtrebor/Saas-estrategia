...
const marcaDemo = {
  ...
  identidad_visual: {
    ...
    logo_url: "https://via.placeholder.com/400x400.png?text=LOGO",
  },
  credenciales_redes: {
    instagram_business_id: "PENDIENTE", // Se configura cuando el cliente conecte Instagram
    telegram_chat_id: "677028989",       // Chat ID del operador (Estudio Precinto)
  },
