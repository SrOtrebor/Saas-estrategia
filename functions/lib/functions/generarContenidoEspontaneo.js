...
exports.generarContenidoEspontaneo = functions
    ...
    try {
        ...
        const sheetUrl = await (0, googleSheets_1.actualizarPlanillaExistente)(marca.google_sheet_id || "PENDIENTE", [fila]);
...
async function enviarCarruselTelegram(chatId, contenido, imageUrls, postId, sheetUrl) {
    ...
    try {
        ...
        let mensajeCopy = `📝 *Copy para Instagram:*\n\n${contenido.copy_instagram}\n\n` +
            `🏷️ *Hashtags:*\n${contenido.hashtags}\n\n` +
